...
package com.example.kurtqin.test.Account.request;
...
import com.example.kurtqin.test.Account.utils.Device;
import com.example.kurtqin.test.Account.utils.LogUtil;
...
public class HostManager {
    ...
    public static final String URL_SHOPAPI_ROOT = SnowApplication.isUserDebug() ? TEST_SHOPAPI_ROOT:FORMAL_SHOPAPI_ROOT;
    ...
    public static final String DOMAIN_APP_SHOPAPI = SnowApplication.isUserDebug() ? TEST_DOMAIN_APP_SHOPAPI
            : FORMAL_DOMAIN_APP_SHOPAPI;

    /** 各个业务的Authority **/
    public static final String URL_XIAOMI_M = SnowApplication.isUserDebug() ? TEST_URL_XIAOMI_M
            : FORMAL_URL_XIAOMI_M;
    public static final String URL_XIAOMI_SHOPAPI_ROOT = SnowApplication.isUserDebug() ? TEST_URL_XIAOMI_SHOPAPI_ROOT
     ...
     * 
     * @see //https://zlping.iteye.com/blog/1633213 webview管理cookies在各版本中的区别
     */
...
//            // 无论如何，都会将UserId种上
//            HostManager.setCookie(context, Parameters.Keys.USER_ID,
...
//                HostManager.setCookie(context, Parameters.Keys.SERVICE_TOKEN,
...
//                HostManager.setCookie(context, Parameters.Keys.PASS_TOKEN,
...
//                setCookie(context, Parameters.Keys.SERVICE_TOKEN,
...
//    }
    ...
    public static void removeLoginCookies(Context context) {
        ...
        HostManager.removeCookie(context, Parameters.Keys.SERVICE_TOKEN,
                DOMAIN_T_HD);
        CookieSyncManager.getInstance().sync();
    ...
    public static void initSettingCookies(Context context) {
        HostManager.setCookie(context,
                Parameters.Keys.COOKIE_NAME_PLATFORM,
                Parameters.Values.COOKIE_VALUE_PLATFROM);
    }
}
