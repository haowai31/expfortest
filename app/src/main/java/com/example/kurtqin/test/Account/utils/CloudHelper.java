...
import com.example.kurtqin.test.Account.exception.AccessDeniedException;
import com.example.kurtqin.test.Account.exception.InvalidCredentialException;
import com.example.kurtqin.test.Account.exception.InvalidResponseException;
...
public final class CloudHelper {
    ...
    public static AccountInfo getServiceTokenByPassToken(String userId,
        ...
        SimpleRequest.StringContent loginContent = SimpleRequest.getAsString(Constants.Account.URL_LOGIN, params, cookies, false);
        if (loginContent == null) {
